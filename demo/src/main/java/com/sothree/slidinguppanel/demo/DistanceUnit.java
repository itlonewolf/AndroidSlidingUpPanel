...
public class DistanceUnit extends ARefreshable {
    Paint mLinePaint;
    ...
    public DistanceUnit(int width) {
        this.width = width;
    }
    
    public static DistanceUnit demoBean(int width) {
        final DistanceUnit distanceBean = new DistanceUnit(width);
